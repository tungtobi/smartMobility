...
public class RegisterActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private String reg_url = "http://18.188.242.150/api/User";
        ...
        if (cancel) {
            ...
            /*StringRequest stringRequest = new StringRequest(Request.Method.POST, reg_url,
                ...
                public void onErrorResponse(VolleyError error) {
                    Toast.makeText(getApplication(), error + "XX", Toast.LENGTH_SHORT).show();
                }
            }){
                @Override
    ...
    private void post(String email, String pass) {
        ...
        Response.Listener<JSONObject> successHandler = new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                Toast.makeText(getApplication(), "Registration successful\n" + response.toString(), Toast.LENGTH_LONG).show();
            }
        };
    ...
    /*
    private void postJson(final String email, final String password) {
        // Post params to be sent to the server
        HashMap<String, String> params = new HashMap<String, String>();
        params.put("Username", email);
        params.put("Password", password);

        JsonObjectRequest req = new JsonObjectRequest(reg_url, new JSONObject(params),
        ...
        MySingleton.getmInstance(RegisterActivity.this).addToRequestque(req);
    }
    ...
    private void postData(String email, String password) {
        try {
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, reg_url,
                ...
                @Override
                public void onResponse(String response) {
                    Toast.makeText(getApplication(), response + "AI", Toast.LENGTH_SHORT).show();
                }
            }, new Response.ErrorListener() {
                @Override
                public void onErrorResponse(VolleyError error) {
                    Toast.makeText(getApplication(), error + "XX", Toast.LENGTH_LONG).show();
                }
            }){
                @Override
    ...
    public static void POST(String email, String pass){
        JSONObject data = new JSONObject();
        try {
            data.put("Username", email);
            data.put("Password", pass);

            new SendDeviceDetails().execute("http://18.188.242.150/api/User", data.toString());
        } catch (JSONException e) {
            e.printStackTrace();
        }
    }
